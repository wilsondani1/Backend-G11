...
class TareaController(Resource):
    ...
    def get(self):
         # TODO:
        # O: utilizando query params poder recibir el nombre, fecha_vencimiento o el estado y devolver solamente esas tareas con esos filtros especializados solo del usuario
