...
SECRET_KEY = 'django-insecure-i$w2pyb$os+v=ywuytxc7xy#2w)7$0+v6uxz(f8d%3r9f$6(=v'
...
INSTALLED_APPS = [
    ...
    'gestion',
    # sirevepara indicar  que ahor avmos a poder acceder a  todos los recursos de  DRF 
    'rest_framework',
]
