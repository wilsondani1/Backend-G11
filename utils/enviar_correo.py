...
>
  ...
  >
    ...
    email_emisor = 'wilson_dani1@hotmail.com'
    password_email_emisor = 'xxxxxxx'

    mensaje ['Subjet'] = titulo
    #agrege el titulo al mensaje 
    mensaje .attach(MIMEText(cuerpo,'plain'))

    #agregamos el cuerpo  pero en el cuerpo_html
    ...
    emisor = SMTP ('outlook.office365.com' ,465)
    emisor.starttls()
    ...
    #cerrar la conexion con mi servidor
    emisor.quit()
